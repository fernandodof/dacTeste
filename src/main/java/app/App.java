...
//        genericoDAO.save(funcionario1);
        ...
        List<Produto> produtos = genericoDAO.getAll(Produto.class);
...
//        
//        Map map = new HashMap();
//        map.put("idProduto", 46);
//        List<ItemVenda> itemVendas = genericoDAO.getListResultOfNamedQuery("ItemVenda.produtoVendido", map);
//        System.out.println("--------------------");
//        for (ItemVenda itemVenda : itemVendas) {
//            System.out.println(itemVenda.getId());
//        }
//        
//        Produto produto = (Produto) genericoDAO.getById(Produto.class, 56);
//        genericoDAO.delete(produto);
//        //Criando 2 clientes
