...
public class PanelCadastrarProduto extends javax.swing.JPanel {
    ...
    public PanelCadastrarProduto() {
        ...
        this.btEscolherImagem.addActionListener(tb);
    ...
    private void initComponents() {
        ...
        btEscolherImagem.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        painelMaior.add(btEscolherImagem, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 130, -1, -1));
        ...
        painelMaior.add(btCadastrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 390, -1, -1));

        listMaterial.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jScrollPane1.setViewportView(listMaterial);

        painelMaior.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 210, 500, 170));
    ...
    private class TrataBotao implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource().equals(btEscolherImagem)) {
                try {
